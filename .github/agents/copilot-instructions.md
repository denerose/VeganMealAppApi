...
## Active Technologies
- TypeScript 5.3+ (strict mode, ESNext target, bundler module resolution) + Bun 1.2.3+ (runtime), Prisma 5.x (ORM), date-fns 3.5+ (date library), ESLint 8.x + Prettier 3.x (code quality) (001-001-meal-planning-api)
...
- 001-001-meal-planning-api: Added
