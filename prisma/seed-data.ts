...
export const SEED_USER_SETTINGS = [
  {
    ...
    dailyPreferences: [
      ...
      { day: DayOfWeek.THURSDAY, preferences: { isCreamy: true, isAcidic: false, greenVeg: true, isEasyToMake: true } },
      { day: DayOfWeek.FRIDAY, preferences: { isCreamy: true, isAcidic: false, greenVeg: true, isEasyToMake: false } },
      { day: DayOfWeek.SATURDAY, preferences: { isCreamy: true, isAcidic: false, greenVeg: true, isEasyToMake: false } },
      { day: DayOfWeek.SUNDAY, preferences: { isCreamy: true, isAcidic: false, greenVeg: true, isEasyToMake: true } },
    ],
  },
  {
    tenantId: SEED_TENANTS[1].id,
    ...
    dailyPreferences: [
      { day: DayOfWeek.SUNDAY, preferences: { isCreamy: true, isAcidic: false, greenVeg: true, isEasyToMake: false } },
      ...
      { day: DayOfWeek.FRIDAY, preferences: { isCreamy: true, isAcidic: false, greenVeg: true, isEasyToMake: true } },
      { day: DayOfWeek.SATURDAY, preferences: { isCreamy: true, isAcidic: false, greenVeg: true, isEasyToMake: false } },
    ],
  },
];
